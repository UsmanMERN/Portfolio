  ...
  return (
    <>
      <div className="row my-4 my-lg-0">
        <h1 className="display-5 fw-bold home_title">
          M Usman
          <svg
            width={36}
            height={36}
        ...
        <div className="text-uppercase fw-bolder home_subtitle d-flex align-items-center justify-content-center my-3 text-center">
          ...
          <div className="typewriter-container">
            <Typewriter
              options={{
                strings: [
                  "MERN Maestro 🚀",
                  "React Native Enthusiast ⚛️",
                  "Software Engineering Wizard 🧙‍♂️",
                  "FullStack Developer 💻",
                ],
                autoStart: true,
                loop: true,
                delay: 75, // Add a slight delay between each string for a smoother effect
              }}
            />
          </div>
        </div>
        ...
        <p>
          Crafting Unforgettable <strong>Web Experiences</strong> with Masterful
          Code Composition
        </p>

        <motion.div
          className="py-4"
          whileHover={{ scale: 1.05, transition: { duration: 0.3 } }} // Smoothly increase scale on hover
          whileTap={{ scale: 0.98, transition: { duration: 0.2 } }} // Smoothly decrease scale on tap
        >
          <ScrollLink
            to={"contact"}
            className="py-2 px-5 rounded-3 text-capitalize button home-section--button"
          >
            Let's Connect! <AiOutlineSend className="mb-0" />
          </ScrollLink>
        </motion.div>
      </div>
    </>
